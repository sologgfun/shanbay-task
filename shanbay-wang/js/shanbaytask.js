...
//扇贝查词
		shellapi: function (word,x,y,z,q) {
		        ...
		        content = data.data.content+"<img src='http://images2015.cnblogs.com/blog/885879/201701/885879-20170104195122081-2070857638.png' width='25px' height='25px' style='margin-left:5px' id='horn'></a>"+"<br>"+data.data.pronunciation+"<br>"+data.data.definition;
				$(".card").remove();
